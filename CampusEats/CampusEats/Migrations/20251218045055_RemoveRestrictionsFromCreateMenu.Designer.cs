...
namespace CampusEats.Migrations
{
    ...
    [Migration("20251218045055_RemoveRestrictionsFromCreateMenu")]
    partial class RemoveRestrictionsFromCreateMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CampusEats.Features.Menu.Menu", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("ItemId")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasAnnotation("Relational:JsonPropertyName", "ItemIds");
